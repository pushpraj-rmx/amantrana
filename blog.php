                ...
                <div class="col-md-8 animate-box" data-animate-effect="fadeInUp">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="post.php"> <img src="images/blog/1.jpg" alt=""> </a>
                                </div>
                                <div class="post-cont"> <a href="blog.php"><span class="tag">Face Makeup</span></a>
                                    <h5>
                        ...
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="post.php"> <img src="images/blog/2.jpg" alt=""> </a>
                                </div>
                                <div class="post-cont"> <a href="blog.php"><span class="tag">Eyebrow Makeup</span></a>
                                    <h5>
                        ...
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="post.php"> <img src="images/blog/3.jpg" alt=""> </a>
                                </div>
                                <div class="post-cont"> <a href="blog.php"><span class="tag">Haircut Makeup</span></a>
                                    <h5>
                    ...
                    <div class="blog-sidebar row">
                        ...
                        <div class="col-md-12">
                            <div class="widget">
                                ...
                                <ul class="recent">
                                    <li>
                                        <div class="thum"> <img src="images/blog/1.jpg" alt=""> </div> <a href="#">8 Ways To Wear Flowers In Your Hair</a>
                                    </li>
                                    <li>
                                        <div class="thum"> <img src="images/blog/2.jpg" alt=""> </div> <a href="#">What To Expect At Your Hair And Makeup Trial.</a>
                                    </li>
                                    <li>
                                        <div class="thum"> <img src="images/blog/3.jpg" alt=""> </div> <a href="#">So You Want To Be A Makeup Artist?</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="widget">
                                ...
                                <ul>
                                    <li><a href="post.php"><i class="ti-angle-right"></i>Hair Makeup</a></li>
                                    <li><a href="post.php"><i class="ti-angle-right"></i>Face Makeup</a></li>
                                    <li><a href="post.php"><i class="ti-angle-right"></i>Eyebrow Makeup</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-12">
